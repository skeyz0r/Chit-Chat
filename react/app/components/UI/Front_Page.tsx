...
export default function FrontPage(props:{session:any})
{
    ...
    return(
        ...
        <LeftBar setMessages={setMessages} chatList={chat_list}  setList={setList} setToast={setToast} setNewChat={setNewChat} setChat={setChat} username={String(props.session.user.name)} id={Number(props.session?.user.id)}/>
       { chat.id ?
