...
export default function LeftBar(props:{chat:any, newChat:any, chatList:any, setMessages:any, setList:any, setToast:any, setChat:any, setNewChat:any, username:string, id:Number})
{
